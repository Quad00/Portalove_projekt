...
<div class="content products" id="menu-2">
		...
		<div class="content homepage" id="menu-1">
			<div class="container">
					<div class="row">
						<?php 
 							foreach ($catItems as $catItems) {
 								?>

 							<a href="obrazky.php?id=<?php echo $catItems["id"];?> ">
						<div class="col-md-4 col-sm-6">
							<div class="product-item">
								<img src="<?php echo $catItems["kat_obrazok"];?>"  style="height:200px;" alt="<?php echo $catItems["nazov"];?>">
								<a href="obrazky.php?id=<?php echo $catItems["id"];?>" class="product-title"><?php echo $catItems["nazov"] ?></a>
							</div> <!-- /.product-item -->
						</div> <!-- /.col-md-4 -->
					</a>
						<?php
